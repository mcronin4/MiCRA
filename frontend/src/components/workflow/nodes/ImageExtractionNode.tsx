          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isRunning}
                className="nodrag w-full pl-9 pr-3 py-2.5 text-sm border border-slate-200 rounded-xl bg-slate-50 focus:bg-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-400 transition-all"
              />
            </div>
          </div>
        )}
              ...
              <div className="flex flex-col items-center justify-center text-center py-4">
                ...
                <p
                  className={`text-sm font-medium ${
                    isDragging ? "text-amber-700" : "text-slate-700"
                  }`}
                >
