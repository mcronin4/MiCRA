...
export function PreviewPageSkeleton() {
  return (
    <div className="flex-1 flex overflow-hidden">
      {/* Sidebar skeleton */}
      <div className="w-64 border-r border-slate-100 p-4 space-y-3 bg-white">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="h-12 border-b border-slate-200 bg-slate-50/50 px-6 flex items-center gap-4 shrink-0">
          <div className="h-8 w-24 bg-slate-200 rounded-lg animate-pulse" />
          <div className="h-8 w-20 bg-slate-200 rounded animate-pulse" />
          <div className="h-8 w-16 bg-slate-200 rounded animate-pulse" />
        </div>
        <div className="flex-1 p-8 bg-slate-50/30 overflow-auto">
