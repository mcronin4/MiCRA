...
export type WorkflowNodeType = 'ImageMatching' | 'Transcription' | 'TextGeneration' | 'ImageExtraction';
...
export const WORKFLOW_NODES: readonly WorkflowNodeType[] = ['ImageMatching', 'Transcription', 'TextGeneration', 'ImageExtraction'];
